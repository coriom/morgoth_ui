...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("font-sans text-sm font-semibold text-textPrimary", className)} {...props} />
  ),
);
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("font-sans text-sm text-textSecondary", className)} {...props} />
));
